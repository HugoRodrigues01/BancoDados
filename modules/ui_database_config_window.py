# Form implementation generated from reading ui file 'modules/ui_files/database_config_window.ui'
#
...
"}")
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("modules/ui_files/../../images/icons/16x16/show_password.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        icon.addPixmap(QtGui.QPixmap("modules/ui_files/../../images/icons/16x16/hide_password.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.On)
...
"")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("modules/ui_files/../../images/icons/16x16/computador(3).png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
...
"}")
        ...
        self.push_button_connect = QtWidgets.QPushButton(self.frame_setting_database)
        self.push_button_connect.setCursor(QtGui.QCursor(QtCore.Qt.CursorShape.PointingHandCursor))
        self.push_button_connect.setStyleSheet("QPushButton {\n"
"color: black;\n"
...
"}")
        ...
        self.horizontal_layout_buttons_sc.addWidget(self.push_button_connect)
...
"background-color: none;")
        ...
        DataBaseConfigWindow.setTabOrder(self.push_button_cancel, self.push_button_connect)
    ...
    def retranslateUi(self, DataBaseConfigWindow):
        ...
        self.push_button_connect.setText(_translate("DataBaseConfigWindow", "Connect"))
